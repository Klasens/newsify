    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            if (!(location === '/me')) location.reload(true);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log(res);
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Success! Welcome to Newsify!');
            window.setTimeout(function () {
              location.assign('/me');
            }, 1500);
          }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alert.showAlert)('fail', _context.t0.response.data.message.errors.email.message);
        case 13:
        case "end":
          return _context.stop();
      }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"bookmark.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Bookmark Saved!');
          }
          _context.next = 10;
          break;
        case 7:
...
var moreInfoHeader = document.querySelectorAll('.modal__list--container');
if (moreInfo) moreInfo.addEventListener('click', function () {
  for (var i = 0; i < moreInfoHeader.length; i++) {
...
// ACOUNT SELECTORS
var languages = document.getElementById('list1');
var languagesBtn = document.getElementById('list1Btn');
var countries = document.getElementById('list2');
var countriesBtn = document.getElementById('list2Btn');
var dateRange = document.getElementById('list3');
var dateRangeBtn = document.getElementById('list3Btn');
if (languagesBtn) languagesBtn.addEventListener('click', function () {
...
if (countriesBtn) countriesBtn.addEventListener('click', function () {
...
if (dateRangeBtn) dateRangeBtn.addEventListener('click', function () {
...
var generalHeadlines = document.getElementById('general');
var worldHeadlines = document.getElementById('world');
var nationHeadlines = document.getElementById('nation');
var businessHeadlines = document.getElementById('business');
var technologyHeadlines = document.getElementById('technology');
var entertainmentHeadlines = document.getElementById('entertainment');
var sportsHeadlines = document.getElementById('sports');
var scienceHeadlines = document.getElementById('science');
var healthHeadlines = document.getElementById('health');
...
var resultsTotal = document.querySelector('.results');
...
var getArticles = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(query) {
    var res, data, markupTotal, markupPreview;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
        ...
        case 9:
          ...
          markupTotal = function markupTotal() {
            var total = state.totalArticles;
            var html = "\n      <div class=\"results__total\">Total Articles Found - ".concat(total, "</div>\n      ");
          ...
          markupPreview = function markupPreview(result, index) {
            return "\n      <a href=\"#".concat(index, "\">\n        <li class=\"results__list-item\"><img class=\"results__img\" crossorigin=\"anonymous\" src=\"https://newsify.herokuapp.com/").concat(result.image, "\" alt=\"").concat(result.title, "\"/>\n          <div class=\"results__list-item--container\">\n            <h4 class=\"results__title\">").concat(result.title, "</h4>\n            <span class=\"results__source\">").concat(result.source.name, "</span>\n          </div>\n        </li>\n      </a>\n      ");
          };
...
if (generalHeadlines) generalHeadlines.addEventListener('click', function () {
  getTopHeadlines('general');
});
if (worldHeadlines) worldHeadlines.addEventListener('click', function () {
  getTopHeadlines('world');
});
if (nationHeadlines) nationHeadlines.addEventListener('click', function () {
  getTopHeadlines('nation');
});
if (businessHeadlines) businessHeadlines.addEventListener('click', function () {
  getTopHeadlines('business');
});
if (technologyHeadlines) technologyHeadlines.addEventListener('click', function () {
  getTopHeadlines('technology');
});
if (entertainmentHeadlines) entertainmentHeadlines.addEventListener('click', function () {
  getTopHeadlines('entertainment');
});
if (sportsHeadlines) sportsHeadlines.addEventListener('click', function () {
  getTopHeadlines('sports');
});
if (scienceHeadlines) scienceHeadlines.addEventListener('click', function () {
  getTopHeadlines('science');
});
if (healthHeadlines) healthHeadlines.addEventListener('click', function () {
  getTopHeadlines('health');
});
var getTopHeadlines = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return fetch("https://gnews.io/api/v4/top-headlines?category=".concat(String(id), "&apikey=1f0b1616e135b0f18fb4cb8923c548e8"));
        case 3:
          res = _context3.sent;
          _context3.next = 6;
          return res.json();
